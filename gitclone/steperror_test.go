...
func newRec(err errormapper.DetailedError) steperror.Recommendation {
	return steperror.Recommendation(errormapper.NewDetailedErrorRecommendation(err))
}
