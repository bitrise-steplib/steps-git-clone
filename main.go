...
func createConfigsModelFromEnvs() ConfigsModel {
	return ConfigsModel{
		...
		PatchArgs: 				os.Getenv("patch_args"),
...
func (configs ConfigsModel) print() {
	...
	log.Printf("- PatchArgs: %s", configs.PatchArgs)
...
func main() {
	...
	git.ConfigureCheckout(configs.PullRequestID, configs.PullRequestURI, configs.PullRequestMergeBranch, configs.Commit, configs.Tag, configs.Branch, configs.BranchDest, configs.CloneDepth, configs.BuildURL, configs.BuildAPIToken, configs.PatchArgs)
